			...
			<div class="room-wrap">
				<table class="room-show">
					...
					<tr class="tr-1 room-capacity">
						...
						<td>
							<a href="/bookInfoInput.do?roomNo=<%=r.getRoomNo() %>&roomPrice=<%=r.getRoomPrice() %>&bookPeople=<%=bookPeople %>&checkIn=<%=checkIn %>&checkOut=<%=checkOut %>&payStayDay=<%=diffDays %>&roomName=<%=r.getRoomName() %>" >
